...
const URL_THIS_WEEK: string =
    'https://api.rawg.io/api/games/lists/recent-games?discover=true&key=c542e67aec3a4340908f9de9e86038af&ordering=-added&page=2&page_size=20'
...
function ContentSectionThisWeek() {
...
export default ContentSectionThisWeek
